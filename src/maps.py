...
for month in monthlist:
    ...
    europecopy.plot(column=month, ax=ax, legend=False, cmap=adjusted_plasma_cmap, edgecolor='gray', linewidth=0.15, missing_kwds={'color': 'gainsboro'}, vmin=vmin, vmax=vmax, norm=plt.Normalize(vmin=vmin, vmax=vmax))
    ...
    #CHANGE ACCORDINGLY
    filepath = os.path.join(output_path,"{}_{}_cumu_mil_comm.png".format(i, month))
...
for quarter in quarters:
    ...
    europecopy.plot(column=quarter, ax=ax, legend=False, cmap=adjusted_plasma_cmap, edgecolor='gray', linewidth=0.15, missing_kwds={'color': 'gainsboro'}, vmin=vmin, vmax=vmax, norm=plt.Normalize(vmin=vmin, vmax=vmax))
...
#military comm maps
input_folder = "output/military comm maps"
...
for month in monthlist:
    ...
    #COLUMN TO PLOT IS THE MONTH COLUMN
    europecopy.plot(column=month, ax=ax, legend=False, cmap='plasma', edgecolor='gray', linewidth=0.15, missing_kwds={'color': 'gainsboro'}, vmin=vmin, vmax=vmax, norm=plt.Normalize(vmin=vmin, vmax=vmax))
...
for quarter in quarters:
    ...
    #COLUMN TO PLOT IS THE QUARTER COLUMN
    europecopy.plot(column=quarter, ax=ax, legend=False, cmap='plasma', edgecolor='gray', linewidth=0.15, missing_kwds={'color': 'gainsboro'}, vmin=vmin, vmax=vmax, norm=plt.Normalize(vmin=vmin, vmax=vmax))
